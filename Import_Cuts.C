...
//TChain *Cuts = new TChain("T");
//Cuts->Add("~/Tritium/Analysis/He3/Test_Cuts.root");

//TFile f("~/Tritium/Analysis/He3/Test_Cuts.root");
//TFile *_file0 = TFile::Open("~/Tritium/Analysis/He3/Test_Cuts.root");
//TCutG* mycut = (TCutG*)gRoot->FindObject("cutg0");
//mycut->Dump();
...
void Import_Cuts() 
{
  ...
  //TFile f1("~/Tritium/Analysis/He3/Test_Cuts.root","recreate");
  TFile f1("Test_Cuts.root");
  cout<<"Size of f1 = "<<f1.Sizeof()<<endl; 
  f1.ls();
  //f1.Print();
  //TFile *file1 = TFile::Open("~/Tritium/Analysis/He3/Test_Cuts.root");

  f1->ReadAll();
  f1->Close();
  //TCutG *mycut;
  //mycut = (TCutG*)gROOT->GetListOfSpecials()->FindObject("cutg0");
